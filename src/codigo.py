...
""" Este bloque de código realiza un análisis básico de la relación entre la percepción de 
corrupción y el puntaje de felicidad en los países. Se agrupan los datos por cuartiles de 
corrupción, se calcula la felicidad promedio y se visualiza mediante un gráfico de barras."""
# -----------------------------------------------------------

def analizar_corrupcion(df, corruption_col, score_col):
    # Invertir escala: 0 = sin corrupción, 1 = corrupción muy alta
    df["corrup_real"] = 1 - df[corruption_col]

    # Cuartiles de corrupción
    ...
    plt.ylim(2, 8)  # porque la felicidad va entre 2 y 8
    plt.tight_layout()
    plt.show()

    # correlación corrupción versus felicidad
    try:
...
""" Este bloque de código muestra los países más felices, genera un mapa interactivo del 
índice de felicidad y un gráfico radar que muestra los factores que más influyen en la felicidad. 
Se utiliza Plotly para crear visualizaciones interactivas que permiten explorar los datos de 
manera más efectiva."""
# -----------------------------------------------------------
...
""" Este bloque de código ejecuta las funciones definidas anteriormente y las visualizaciones
preparadas."""
# -----------------------------------------------------------
